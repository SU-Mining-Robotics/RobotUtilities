...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera_0', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'a200_1057', 'description': 'namespace for camera'},
