...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('namespace',      default_value='a200_1057',            description=''),
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='camera_0/color/image_raw',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='camera_0/depth/image_rect_raw', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='camera_0/color/camera_info',            description=''),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='platform/odom',  description='Odometry topic name.'),
